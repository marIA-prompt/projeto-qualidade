...
import { carregarPerfil, reclassificarMes } from "@/lib/dados";
import { pontuacaoPilar } from "@/lib/pilares";
import { createClient } from "@/lib/supabase/server";
import { montarRelatorioMensal } from "@/lib/relatorios";
import { alertasDoMes, carregarClassificacoes, resumoAuditorias } from "@/lib/dados";
...
export async function registrarRelatorio(formData: FormData) {
  ...
  const alertas = alertasDoMes(recorte, resumo, mes);
